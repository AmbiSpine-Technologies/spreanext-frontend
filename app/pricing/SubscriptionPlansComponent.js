          ...
          <>
            ...
            <div className="relative px-8 pt-8 pb-6 text-center">
              ...
              <div className="mb-4 flex justify-center">
                <div className="w-20 h-20 bg-gradient-to-br from-amber-500 to-amber-600 rounded-2xl flex items-center justify-center shadow-xl">
              ...
              <p className="text-gray-600">
                Unlock all premium features and boost your career with{" "}
            ...
            <div className="grid md:grid-cols-2 gap-0">
              {/* Left Side - Features */}
              <div className="bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 px-8 py-10">
              ...
              <div className="bg-gradient-to-br from-slate-100 to-slate-200 rounded-2xl p-6 mb-6">
                ...
                <div className="space-y-3 mb-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-slate-800">All Premium Features</span>
                  </div>
                </div>
              ...
              <div className="mb-6">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 mb-8 border border-blue-200">
                  <p className="text-sm text-slate-600">
                    ✨ You now have access to all premium features including mentor consultations!
                  </p>
                </div>
              </div>
